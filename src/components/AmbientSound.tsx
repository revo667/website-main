            ...
            {SOUNDS.map((s) => {
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-3 w-full rounded-xl p-2 text-left text-xs transition-all active:scale-[0.98] ${currentSound.id === s.id ? "bg-white text-black font-bold" : "text-white/60 hover:bg-white/5"}`}
                  style={{
